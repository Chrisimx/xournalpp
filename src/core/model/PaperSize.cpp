...
PaperSize::PaperSize(PaperFormatUtils::GtkPaperSizeUniquePtr_t& gtkPaperSize):
...
PaperSize::PaperSize(PageTemplateSettings& model): width(model.getPageWidth()), height(model.getPageHeight()) {}
...
auto PaperSize::areDoublesEqual(double x, double y) -> bool { return static_cast<int>(x - y) == 0; }
